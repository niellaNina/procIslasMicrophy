...
def read_nav2(flights, main_path,file_struct):
    """
    Second attempt at writing read_nav function
    
    :param flights: Description
    """
   ...
   # import read_flight_report
    ...
    for flight in flights:
        ...
        nav_file = glob.glob(main_path + flight + file_struct) # returns a list, must access with file[0]
...
def get_nav_dim_coord(flights):
   ...
   # import read_flight_report
    ...
    for flight in flights:
        ...
        nav_file = glob.glob(main_path + flight + nav_file_struct_nav) # returns a list, must access with file[0]
        nav_xds = xr.open_dataset(nav_file[0]) # returns an xarray dataset
