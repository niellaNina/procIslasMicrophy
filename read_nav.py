...
def read_nav():
    ...
    for flight in flights:
        ...
        stats_dict['lat_max'] = nav_xds.attrs['geospatial_lat_max']
        stats_dict['lat_min'] = nav_xds.attrs['geospatial_lat_min']
        stats_dict['lon_max'] = nav_xds.attrs['geospatial_lon_max']
        stats_dict['lon_min'] = nav_xds.attrs['geospatial_lon_min']
    ...
    return(islas_nav_df, islas_stats_dict)
